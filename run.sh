...
sudo PYTHONPATH=/home/fpniu/.local/lib/python3.11/site-packages cgexec -g memory:8gb \
...
sudo PYTHONPATH=/home/fpniu/.local/lib/python3.11/site-packages cgexec -g memory:4gb \
...
sudo PYTHONPATH=/home/fpniu/.local/lib/python3.11/site-packages cgexec -g memory:16gb \
...
sudo PYTHONPATH=/home/fpniu/.local/lib/python3.11/site-packages cgexec -g memory:16gb \
  python3 -W ignore run_ginex.py --dataset=soc-friendster --num-epochs=3 --neigh-cache-size 8000000000 --feature-cache-size 4000000000 --sb-size 3600 --verbose \
